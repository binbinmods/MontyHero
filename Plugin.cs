...
namespace Monty
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Monty";
        public static string heroName = characterName;

        public static string subclassName = "Bunny"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Monty, the Bunny.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Monty",
                _contentFolder: "Monty",
